...
<section id="joerivanveen-eu-flag">
    ...
    <h3>WP reading progress <a href="https://wordpress.org/plugins/wp-reading-progress/">⚭</a></h3><p><span class="rating">⭐⭐⭐⭐⭐</span> (2k+ users). Check it on my <a href="https://www.joerivanveen.com/blog">blog posts</a>.</p>
    <h3>Each domain a page <a href="https://wordpress.org/plugins/each-domain-a-page/">⚭</a></h3><p>⭐⭐⭐⭐⭐ Enables me to easily show a single page (or post) on a domain, for SEO purposes (e.g. <a href="https://wp-developer.eu">wp-developer.eu</a>, <a href="https://joerivanveen.eu">joerivanveen.eu</a>), from a single installation.</p>
    ...
    <h3>Compare table <a href="https://wordpress.org/plugins/compare-table/">⚭</a></h3><p>Have your visitors compare items, services or anything really, by providing criteria from an easy admin interface.</p>
</section>
